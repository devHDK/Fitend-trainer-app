...
import 'package:fitend_trainer_app/thread/component/edit_video_player.dart';
...
class _AssetEditScreenState extends ConsumerState<CommentAssetEditScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final state = ref.watch(commentCreateProvider(family));
            ...
            child: PageView.builder(
              ...
              itemBuilder: (context, index) {
                return type == MediaType.image
                    ? _editImageView(file, state, family)
                    : EditVideoPlayer(
                        file: file,
                        index: index,
                        isComment: true,
  ...
  Column _editImageView(
      File file, ThreadCommentCreateTempModel state, ThreadFamilyModel family) {
    return Column(
      children: [
        Expanded(
          child: SizedBox(
