  ...
  InkWell _pickImage(
    ...
    return InkWell(
      onTap: isComment && threadId != null
          ? () async {
              final family =
                  ThreadFamilyModel(threadId: threadId, user: widget.user);
              final model = ref.read(commentCreateProvider(family));
          ...
          : () async {
              final model = ref.read(threadCreateProvider(widget.user));
