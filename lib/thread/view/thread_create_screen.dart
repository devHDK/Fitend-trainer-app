...
import 'package:fitend_trainer_app/common/component/tip_bubble.dart';
...
import 'package:fitend_trainer_app/thread/view/thread_asset_edit_screen.dart';
...
class _ThreadCreateScreenState extends ConsumerState<ThreadCreateScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      if (widget.threadEditModel != null) {
        ...
        await ref.read(threadCreateProvider(widget.user).notifier).init();
        ...
        model = ref.read(threadCreateProvider(widget.user));
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(threadCreateProvider(widget.user));
                            ...
                            await ref
                              ...
                              if (value != null) {
                                ...
                                final family = ThreadFamilyModel(
                                    threadId: widget.threadEditModel!.threadId,
                                    user: widget.user);
                                ref
                        ...
                        InkWell(
                          onTap: () async {
                            if (state.assetsPaths!.length < 10) {
                              await ref
                                  .read(threadCreateProvider(widget.user)
                                      .notifier)
                                  .pickImage(
                                ...
                                if (assets != null && assets.isNotEmpty) {
                                  ...
                                  for (var asset in assets) {
                                    if (await asset.file != null) {
                                      ...
                                      ref
                                          .read(
                                              threadCreateProvider(widget.user)
                                                  .notifier)
                                          .addAssets(file!.path);
