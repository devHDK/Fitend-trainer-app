...
class _ThreadDetailState extends ConsumerState<ThreadDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    final threadListState = ref.watch(threadProvider(widget.user));
    final userModel = trainerState as TrainerModel;
    ...
    if (model.emojis != null && model.emojis!.isNotEmpty) {
      emojiButtons = _buildEmojiButtons(model, threadListModel, family);
    }

    emojiButtons.add(
      _defaultEmojiButton(context, model, threadListModel, family),
    );
        ...
        children: [
          Stack(
            children: [
              ...
              if (model.writerType == 'trainer' &&
                  model.trainer.id == userModel.trainer.id &&
                      ...
                      edit: () {
                        ...
                        Navigator.of(context)
                          ...
                          if (value is bool && value) {
                            await ref
                                .read(
                                    threadCreateProvider(widget.user).notifier)
                                .init();
                          }
                        });
                      },
  ...
  List<Widget> _buildEmojiButtons(ThreadModel model,
      ThreadListModel threadListModel, ThreadFamilyModel family) {
